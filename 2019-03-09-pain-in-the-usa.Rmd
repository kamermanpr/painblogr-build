...
description: "Arthritic pain in the USA?"
output:
    html_document:
...
library(fiftystater) # For a map of the USA
...
```{r clean_data}
#-- Import data --#
load('_data/2019-03-09-pain-in-the-usa/brfss2013.RData')
...
if(!file.exists('_data/2019-03-09-pain-in-the-usa/brfss2013_design.RData')) {
    #-- Set options for control standard error estimation --#
    options(survey.lonely.psu = 'certainty')
    ...
    write_rds(brfss2013_design, 
              path = '_data/2019-03-09-pain-in-the-usa/brfss2013_design.RData', 
              compress = 'gz')
} else {
    options( survey.lonely.psu = 'certainty' )
    #-- Load saved design object --#
    brfss2013_design <- read_rds('_data/2019-03-09-pain-in-the-usa/brfss2013_design.RData')
}
...
##### Generate the arthritis by state data
...
if(!file.exists('_data/2019-03-09-pain-in-the-usa/arthritis_state.RData')) {
    #-- Set options for control standard error estimation --#
    options(survey.lonely.psu = 'certainty')
    ...
    write_rds(arthritis_state, 
              path = '_data/2019-03-09-pain-in-the-usa/arthritis_state.RData', 
              compress = 'gz')
} else {
    #-- Load saved design object --#
    arthritis_state <- read_rds('_data/2019-03-09-pain-in-the-usa/arthritis_state.RData')
}
```
...
##### Generate the arthritis by state for each age group data
...
if(!file.exists('_data/2019-03-09-pain-in-the-usa/arthritis_age.RData')) {
    #-- Set options for control standard error estimation --#
    options(survey.lonely.psu = 'certainty')
    ...
    write_rds(arthritis_age, 
              path = '_data/2019-03-09-pain-in-the-usa/arthritis_age.RData', 
              compress = 'gz')
} else {
    #-- Load saved design object --#
    arthritis_age <- read_rds('_data/2019-03-09-pain-in-the-usa/arthritis_age.RData')
}
```
...
##### Generate the arthritis by state for each sex data
...
if(!file.exists('_data/2019-03-09-pain-in-the-usa/arthritis_sex.RData')) {
    #-- Set options for control standard error estimation --#
    options(survey.lonely.psu = 'certainty')
    ...
    write_rds(arthritis_sex, 
              path = '_data/2019-03-09-pain-in-the-usa/arthritis_sex.RData', 
              compress = 'gz')
} else {
    #-- Load saved design object --#
    arthritis_sex <- read_rds('_data/2019-03-09-pain-in-the-usa/arthritis_sex.RData')
}
```
